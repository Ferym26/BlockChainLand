...
(function () {
	...
	function animations() {
		...
		var anim_appArea = appArea.addLabel("start", "+=0").staggerFrom(".app-area__slider-marker-item", 0.8, {
			y: 80,
			ease: Expo.easeOut,
			delay: 0,
			opacity: 0
			...
			opacity: 0
		}, "start+=1").from('.icon-energo .frame1', 0.3, {
			y: 20,
			opacity: 0
		}, "start+=1.3").from('.icon-energo .frame2', 0.3, {
			y: 20,
			opacity: 0
		}, "start+=1.6");
		...
		var anim_aiml = aiml.staggerFrom(".aiml__slider-item", 0.6, {
			opacity: 0
		}, 0.2);
		...
		var anim_blockchain = blockchain.from(".blockchain", 1.2, {
			x: 300,
			ease: Expo.easeOut,
			delay: 0,
			opacity: 0
