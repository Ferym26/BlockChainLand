...
(function () {
	...
	function animations() {
		...
		var anim_appAreaIcon2 = appAreaIcon2.addLabel("start", "+=0").from('.icon-ts .train', 0.6, {
			opacity: 0,
			delay: 0.3,
			x: -50
		...
		var anim_appAreaIcon3 = appAreaIcon3.addLabel("start", "+=0").from('.icon-eco .globus', 0.9, {
			opacity: 0,
			delay: 0.3,
			y: 80,
			ease: Power4.easeOut,
		...
		var anim_appAreaIcon4 = appAreaIcon4.addLabel("start", "+=0").staggerFrom('.icon-city .windows path', 0.5, {
			delay: 0.3,
			opacity: 0
		}, 0.1).staggerFrom('.icon-city .roots path', 0.5, {
			strokeDasharray: 1e3,
		...
		var anim_appAreaIcon5 = appAreaIcon5.addLabel("start", "+=0").staggerFrom('.icon-parking .waves path', 1.4, {
			delay: 0.3,
			y: 10,
			opacity: 0,
			repeat: -1
		...
		var anim_appAreaIcon6 = appAreaIcon6.addLabel("start", "+=0").staggerFrom('.icon-gaz .col1 rect', 0.6, {
			delay: 0.3,
			opacity: 0
		}, 0.15).staggerFrom('.icon-gaz .col2 rect', 0.6, {
			opacity: 0
		}, 0.1).staggerFrom('.icon-gaz .col3 rect', 0.8, {
			opacity: 0
		}, 0.08);

		var appAreaIcon7 = new TimelineMax({ paused: true });
		var anim_appAreaIcon7 = appAreaIcon7.addLabel("start", "+=0").staggerFrom('.icon-fisk .body path', 0.5, {
			delay: 0.3,
			strokeDasharray: 200,
			strokeDashoffset: 200,
			ease: Expo.easeIn
		}, 0.3).from('.icon-fisk .lighter', 0.5, {
			opacity: 0,
			repeat: -1,
			yoyo: true
		});
		...
		var anim_appAreaIcon8 = appAreaIcon8.addLabel("start", "+=0").from('.icon-tax .lens', 1.6, {
			delay: 0.3,
			rotation: -30,
			repeat: -1,
			yoyo: true,
		...
		var anim_appAreaIcon9 = appAreaIcon9.addLabel("start", "+=0").fromTo('.icon-prognoz .pipe', 1, {
			delay: 0.3,
			scaleX: 1.2,
		...
		var anim_appAreaIcon10 = appAreaIcon10.addLabel("start", "+=0").staggerTo('.icon-osv .gbuttons rect', 1, {
			delay: 0.3,
			y: 2,
			scaleX: 0.85,
			transformOrigin: "50% 50%",
